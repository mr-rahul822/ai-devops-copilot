...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-[240px] bg-[#111827] flex flex-col z-30 shadow-xl border-r border-[#1f2937]">
      {/* Logo */}
      ...
      <nav className="flex-1 mt-4 px-3 overflow-y-auto custom-scrollbar">
        {navItems.map((item) => (
          <NavLink
            ...
            to={item.to}
            className={({ isActive }) =>
              `flex items-center gap-3 px-3 py-2.5 rounded-md text-[13px] font-medium mb-1 transition-colors ${
                isActive
                  ? 'text-white bg-[#1e293b] border-l-[3px] border-[#2563eb]'
                  : 'text-[#94a3b8] hover:text-white hover:bg-[#1e293b]/50 border-l-[3px] border-transparent'
              }`
            }
          >
            <item.icon />
      ...
      <div className="px-3 pb-5 pt-4 border-t border-[#1f2937] space-y-1">
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 text-[#94a3b8] hover:text-red-400 text-[13px] font-medium w-full rounded-md transition-colors"
        >
...
function ChartIcon() {
  return (
    <svg className="w-[18px] h-[18px] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25C7.004 12 7.5 12.504 7.5 13.125v6.75C7.5 20.496 7.004 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" /></svg>
  )
}
function BellIcon() {
  return (
...
function LightningIcon() {
  return (
    <svg className="w-[18px] h-[18px] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" /></svg>
  )
}
function CloudIcon() {
  return (
    <svg className="w-[18px] h-[18px] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15a4.5 4.5 0 004.5 4.5H18a3.75 3.75 0 001.332-7.257 3 3 0 00-3.758-3.848 5.25 5.25 0 00-10.233 2.33A4.502 4.502 0 002.25 15z" /></svg>
  )
}
function PiggyIcon() {
  return (
